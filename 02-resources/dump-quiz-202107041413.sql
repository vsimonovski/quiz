...
CREATE TABLE `answer_explanation` (
  ...
  `question_id` int(10) unsigned NOT NULL,
  UNIQUE KEY `answer_explanation_question_id_IDX` (`question_id`) USING BTREE,
...
INSERT INTO `answer_explanation` VALUES ('pair, liar',1),('Serbia',2),('Red, blue and white',3),('160',4),('malta',5),('bhutan',6),('al',7),('Algeria',8),('Colombia',9),('45',10);
...
INSERT INTO `question` VALUES (1,'uiyljqjpar',1),(2,'RS',2),(3,'Serbia',3),(4,'80 * 2',4),(5,'Malta',3),(6,'Bhutan',3),(7,'AL',2),(8,'DZ',2),(9,'Colombia',3),(10,'5*9',4);
...
-- Dump completed on 2021-07-04 14:13:49
